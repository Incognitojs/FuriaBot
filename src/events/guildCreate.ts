    ...
    execute: async (guild: Guild, client: Client) => {
        ...
        if (!guildExists) {
            ...
            user.send({
                embeds: [{
                    color: '#ec4899',
                    description: "Hey, **thank you** for inviting me! To get started use the `/help` or `/setup` command withing your server. Stuck? join my support discord for quick help. 😺"
                }],
